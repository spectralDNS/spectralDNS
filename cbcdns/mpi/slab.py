...
def create_alias_filter(N, K, family="Isotropic"):
    ...
    if config.dealias == "2/3-rule":
        ...
        kmax = N/2-1  # Just chopping the highest wavenumber. Should not be necessary, but initial white noise seems to build up energy in the higheste wavenumber if this is not removed here.
