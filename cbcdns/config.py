...
Shen.add_argument('--solver', default='IPCS', choices=('IPCS','IPCSR'), help="""Choose solver.""")
Shen.add_argument('--convection', default='Standard', choices=('Standard', 'Standard2', 'Divergence', 'Skew'))
