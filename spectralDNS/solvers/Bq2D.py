...
class ComputeRHS(RhsBase):
    ...
    @staticmethod
    @optimizer
    def add_linear(rhs, ur_hat, P_hat, K_over_K2, K, K2, nu, Ri, Pr):
        u_hat = ur_hat[:2]
        rho_hat = ur_hat[2]
    ...
    def __call__(self, rhs, ur_hat, work, FFT, K, K2, K_over_K2, P_hat, **context):
        ...
        rhs = self.nonlinear(rhs, ur_hat, work, FFT, K)
        rhs = self.add_linear(rhs, ur_hat, P_hat, K_over_K2, K, K2, params.nu,
                              params.Ri, params.Pr)
