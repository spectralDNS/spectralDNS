...
triplyperiodic.add_argument('--integrator', default='RK4', choices=('RK4', 'ForwardEuler', 'AB2',"BS5_adaptive","BS5_adaptive_p","BS5_fixed","IMEX1","EXPBS5","IMEX4","EXPEULER","IMEX3","IMEX5","DP5_adaptive","DP5_fixed","KCL5_adaptive","KCL5_fixed"))
...
parser_Bq3D.add_argument('--Pr',default=1.,type=float,help="Prandl number")
parser_Bq3D.add_argument('--Ri',default=0.2,type=float,help="Richardson number")
...
doublyperiodic.add_argument('--integrator', default='RK4', choices=('RK4', 'ForwardEuler', 'AB2',"BS5_adaptive","BS5_adaptive_p","BS5_fixed","IMEX1","EXPBS5","IMEX4","EXPEULER","IMEX3","IMEX5","DP5_adaptive","DP5_fixed","KCL5_adaptive","KCL5_fixed"))
...
parser_Bq2D.add_argument('--Pr',default=1.,type=float,help="Prandl number")
parser_Bq2D.add_argument('--Ri',default=0.2,type=float,help="Richardson number")
...
channel.add_argument('--dealias_cheb', default=False, help='Use dealiasing for inhomogeneous direction. If True, use same rule as for periodic')
