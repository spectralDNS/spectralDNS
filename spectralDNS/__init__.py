...
def get_solver(update=None, regression_test=None, mesh="triplyperiodic",manually_specified_argv=None,additional_callback=None,silent=False):
    argv = manually_specified_argv or sys.argv[1:]
    context = Context(mesh,argv,silent=silent)
