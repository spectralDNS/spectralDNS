...
def Chmat_matvec(np.ndarray[np.float64_t, ndim=1] ud, np.ndarray[np.float64_t, ndim=1] ld,
...
def Bhmat_matvec(np.float64_t ud, 
                 np.ndarray[np.float64_t, ndim=1] ld,
...
def Cmat_matvec(np.ndarray[np.float64_t, ndim=1] ud, np.ndarray[np.float64_t, ndim=1] ld,
                 np.ndarray[T, ndim=3] v, np.ndarray[T, ndim=3] b):
    cdef:
        int i, j, k
        int N = v.shape[0]-2
