...
The efficiency of the pure numpy/mpi4py solver may be enhanced using cython/weave/numba for certain routines. Possible optimizations are located in folder src/optimization and may be enabled by running the following command in the optimization folder (generates code for both single/double precision) 
