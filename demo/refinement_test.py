...
for i in range(len(dt)):
    output = subprocess.check_output("python OrrSommerfeld.py --refinement_test True --M 7 3 1 --dt %s --T %s --compute_energy 1 --plot_step -1 --convection Vortex --eps 1e-7 --optimization cython KMM"%(str(dt[i]),str(50.0)), shell=True)
