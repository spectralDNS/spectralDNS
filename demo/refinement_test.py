...
dt = array([1./10, 1./15., 1./20., 1./25., 1./30., 1./35., 1./40.])
#dt = array([ 1./35., 1./40.])
...
for i, t in enumerate(dt):
    output = subprocess.check_output("python OrrSommerfeld.py --refinement_test True --M 6 3 2 --dt %s --T %s --compute_energy 1 --plot_step -1 --convection Vortex --eps 1e-7 --optimization cython --Dquad GC --Bquad GC KMM"%(str(t), str(50.0)), shell=True)
