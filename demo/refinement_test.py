...
#dt = array([ 1./10., 1./12., 1./14., 1./16., 1./18., 1./20.])
#dt = array([ 1./5., 1./6., 1./7., 1./8., 1./9.])
#dt = array([0.0025, 0.005, 0.01, 0.02])

for i in range(len(dt)):
    output = subprocess.check_output("python OrrSommerfeld.py --refinement_test True --M 7 5 1 --dt %s --T %s --compute_energy 1000 --plot_step -1 --convection Vortex KMM"%(str(dt[i]),str(2.0)), shell=True)
